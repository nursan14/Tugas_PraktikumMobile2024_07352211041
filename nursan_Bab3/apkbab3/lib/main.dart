      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              const Icon(Icons.star, color: Color.fromARGB(255, 255, 7, 164), size: 16),
...
class FreelancerList extends StatelessWidget {
  final List<Map<String, dynamic>> freelancers = [
    ...
    },
    {
      ...
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/jennie.jpeg"
    },
  ];
    ...
    return Column(
      children: [
        ...
        ServiceCard(
          ...
          name: 'Treasure',
          role: 'BoyGroup',
          description: 'Ini adalah treasure group',
          rating: 5.5,
        ),
        ServiceCard(
          imageUrl: 'assets/images/bymon.png',
          name: 'Baby Monster',
          role: 'GirlGroup',
          description: 'Ini adalah Baby Monster.',
          rating: 4.9,
        ),
      ],
    );
...
class BestBooking2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
        children: [
          BestBookingCard(
            imageUrl: 'assets/images/blackpink.jpeg',
            profileUrl: 'assets/images/pink.png',
            name: 'YG Entertaiment',
            role: 'Beautician',
          ...
          BestBookingCard(
            imageUrl: 'assets/images/blackpink.jpeg',
            profileUrl: 'assets/images/bymon.png',
            name: 'YG Entertaiment',
            role: 'Beautician',
            description: 'Occaecati aut nam beatae quo non deserunt consequatur.',
            rating: 4.9,
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/blackpink.jpeg', // Ganti dengan path gambar Anda
                    height: 230,
                    width: double.infinity,
                    fit: BoxFit.cover,
                  ),
